...
import cn.project.trigger.api.IRaffleActivityService;
import cn.project.trigger.api.dto.ActivityDrawRequestDTO;
import cn.project.trigger.api.dto.ActivityDrawResponseDTO;
import cn.project.trigger.api.dto.UserActivityAccountRequestDTO;
import cn.project.trigger.api.dto.UserActivityAccountResponseDTO;
...
/**
 * @Author: qiyuan
 * @Date: 2025/02/26 17:06
 * @Description: 抽奖活动服务 (在不引用 application/case 层的时候，需要让接口实现层来做领域的串联。
 */
@Slf4j
@RestController()
...
public class RaffleActivityController implements IRaffleActivityService {
     ...
     * 入参：{"activityId":100001,"userId":"qiyuan"}
     * <p>
     * curl --request GET \
     ...
     * 入参：qiyuan
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/calendar_sign_rebate -d "userId=qiyuan" -H "Content-Type: application/x-www-form-urlencoded"
     */
     ...
     * 判断是否签到接口
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/is_calendar_sign_rebate -d "userId=qiyuan" -H "Content-Type: application/x-www-form-urlencoded"
     */
